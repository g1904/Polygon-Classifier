...
def load_dataset():
  ...
  if SHOULD_USE_ARTIFICIAL_DATA:
    ...
    artificial_data = image_dataset_from_directory('outputs/polygons/images', batch_size=1024, image_size=(28, 28), color_mode='grayscale')
    x_train = []
    y_train = []
    ...
    test_data = image_dataset_from_directory('QuickDrawSet/images', batch_size=1024, image_size=(28, 28), color_mode='grayscale')
    x_test = []
    y_test = []
...
x_test_by_class = [[] for i in range(5)]
y_test_by_class = [[] for i in range(5)]
for i in range(len(x_test)):
